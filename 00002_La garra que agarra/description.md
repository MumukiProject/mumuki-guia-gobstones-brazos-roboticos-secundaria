...
> Definí e invocá el procedimiento `AgarrarContenedor` para que mueva el brazo al Sur, saque tantas bolitas azules como la suma del peso del contenedor (número de bolitas Rojas) y el peso del maíz (número de bolitas verdes), y lo `levante`.